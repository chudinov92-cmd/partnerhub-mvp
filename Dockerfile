...
ARG NEXT_PUBLIC_ACCESS_MODE=freemium
ARG NEXT_PUBLIC_PIONEER_PROMO_ENABLED=false
...
ENV NEXT_PUBLIC_ACCESS_MODE=$NEXT_PUBLIC_ACCESS_MODE
ENV NEXT_PUBLIC_PIONEER_PROMO_ENABLED=$NEXT_PUBLIC_PIONEER_PROMO_ENABLED
