-- Hard delete тестового пользователя (profile.id ИЛИ auth_user_id = 83cec896-...).
--
-- На VPS:
--   cd /root/zeip/my-app
--   docker exec -i supabase-db psql -U supabase_admin -d postgres \
--     < supabase/sql/2026-08-13-delete-test-user-83cec896.sql

\set target_uuid '83cec896-9ad0-4834-91c1-15ae2da4bda3'
...
do $$
declare
  v_target uuid := '83cec896-9ad0-4834-91c1-15ae2da4bda3';
  v_profile_id uuid;
  v_auth_user_id uuid;
  v_city text;
