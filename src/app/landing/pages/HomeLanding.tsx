...
export function HomeLanding({ stats = null }: HomeLandingProps) {
  ...
  return (
    <div className="page">
      ...
      <main>
        <FeatureSplit
          title="В одиночку много не построить."
          body={"Один человек не закрывает всё:\nКто-то умеет продавать, но не умеет делать.\nКто-то делает, но не умеет продвигать.\nУ кого-то есть деньги, но нет времени.\nДело идёт, когда каждый делает своё."}
          visual={
