    ...
    <div className="page">
      ...
      <main>
        ...
        <FeatureSplit
          ...
          body="Тебе не нужно искать специалистов на другом конце страны, регистрироваться на форумах или создавать аккаунт на сервисах подбора сотрудников. Твой будущий партнер может пить кофе в кофейне за углом. Зеип сокращает дистанцию до минимума."
          visual={
            // eslint-disable-next-line @next/next/no-img-element -- decorative landing art; skip next/image cache
            <img
